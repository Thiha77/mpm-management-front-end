        ...
        <div class="col">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h2>{$fields.form.title}</h2>
                        </div>
                        <div class="col-sm-4">
                            <a class="btn btn-white float-right" href="attendance/create" ><i class="fas fa-plus-circle"></i>{$fields.form.new}</a>
                        </div>
                    </div>
                </div>
                <table class="table table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>{$fields.attendance.id}</th>						
                            <th>{$fields.attendance.employeeid}</th>
                            <th>{$fields.attendance.employeename}</th>
                            <th>{$fields.attendance.recordeddatetime}</th>
