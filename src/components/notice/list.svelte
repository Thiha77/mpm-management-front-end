            ...
            <div class="">
                <div class="table-wrapper card-list-mpm1">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6"><h3 class="float-left">{$fields.notice.form.title}</h3></div>
                            <div class="col-sm-6"><a class="btn btn-white float-right" href='notice/create'><i class="fas fa-plus-circle"></i>{$fields.notice.form.new}</a></div>
                        </div>
                    </div>
                    <table class="table table-hover table-responsive-sm ">
                        <thead>
                            <tr>
                                <th>{$fields.notice.notice.title}</th>						
                                <th>{$fields.notice.notice.description}</th>
                                <th>{$fields.notice.notice.summary}</th>
                                <th>{$fields.notice.notice.author}</th>
                                <th>{$fields.notice.form.action}</th>
                            </tr>
                        </thead>
                        <tbody>
                            {#if notices}
